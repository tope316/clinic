...
class Brand_Model extends CI_Model {
	...
	function get_data()
	{
		$sqlCount = "select count(*) as xcount from brand";
		...
		$sqlInfo = "select ID, description from brand WHERE 1=1";
	...
	function del()
	{
		...
		$qry = "delete from brand where ID = ?";
	...
	function get_record()
	{
		...
		$qry = $this->db->query("Select ID, description FROM brand where ID = $code");
	...
	function get_list()
	{			
		$qry = $this->db->query("select * from brand WHERE 1=1");
